Исследование влияния точности задания первых двух пар с максимальным по модулю собственным значением на точность опеределния третьей пары методом прямых итераций с исчерпыванием.
